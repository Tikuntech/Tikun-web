...
export default function Footer() {
    return (
        <footer className="bg-[#11112B] text-white py-8">
            <div className="container mx-auto px-4 flex flex-col items-center md:flex-row md:justify-between">
                {/* Logo and Copyright Section */}
                <div className="flex flex-col items-center md:items-start mb-32 md:mb-0 space-y-28">
                    <TikcunteckLogo />
                    <p className="text-sm ">Copyright © Tarun Dixit</p> {/* Increased margin-top */}
                </div>

                {/* Links Section */}
                <div className="flex flex-col md:flex-row md:space-x-10 space-y-8 md:space-y-0 w-full md:w-auto ml-96 mb-5">
                    {/* Explore Section */}
