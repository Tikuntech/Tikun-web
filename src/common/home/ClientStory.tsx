          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 md:mt-20">
            ...
            <div className="text-white flex flex-col md:items-start md:w-1/2">
              ...
              <p className="text-sm md:text-lg mb-4 md:text-left  text-white">
                ...
                needed to focus on our business. They took the time to
                understand our unique needs and created a solution that
                protected our sensitive data and ensured compliance with
            ...
            <div className="text-white flex flex-col md:items-start md:w-1/2">
              ...
              <p className="text-sm md:text-lg mb-4 md:text-left">
                ...
                business until we partnered with Tikuntech. Their custom
                software development solution has helped us streamline our
                operations and improve efficiency, saving us time and money.”
              </p>
              <div className="flex items-end justify-end w-full">
