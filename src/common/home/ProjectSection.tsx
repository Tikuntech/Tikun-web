...
const ProjectSection: React.FC = () => {
  ...
  >
    ...
    {expanded === 2 ? <FaMinus className="ml-10" /> : <FaPlus className="ml-7" />}
  </h1>
  {expanded === 2 && (
    <div className="text-white text-sm md:pl-2 mb-5">
      <p>
        Our solutions are tailored to fit various business needs. Contact us for a custom recommendation.
      </p>
    </div>
  )}
  ...
  >
    ...
    {expanded === 3 ? <FaMinus className="ml-10" /> : <FaPlus className="ml-8" />}
  </h1>
  {expanded === 3 && (
  ...
  >
    ...
    {expanded === 4 ? <FaMinus className="ml-10" /> : <FaPlus className="ml-7" />}
  </h1>
  {expanded === 4 && (
    <div className="text-white text-sm md:pl-2 mb-5">
      <p>
