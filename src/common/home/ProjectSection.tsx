    ...
    <div className="bg-[#11112B]  md:h-full  ">
      ...
      <div className="md:flex md:justify-between md:mt-5 md:pl-20 p-5 ">
        ...
        <div className="md:pr-20 md:w-1/2 ">
          ...
          {/* Accordion Item 2 */}
          <h1
            className="flex text-white mt-5 justify-between font-bold mb-10 md:pl-2 cursor-pointer md:pt-6"
          ...
          {/* Accordion Item 3 */}
          <h1
            className="flex  mt-5 justify-between font-bold md:pl-2 text-custom-blue cursor-pointer md:pt-8"
          ...
          {/* Accordion Item 4 */}
          <h1
            className="flex text-white mt-5 justify-between font-bold mb-10 md:pl-2 cursor-pointer md:pt-7"
