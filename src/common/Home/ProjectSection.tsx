...
const ProjectSection: React.FC = () => {
  return (
    <div
      className="bg-[#11112B] md:py-12  md:px-4 md:h-[1300px]  h-full "
      style={{ padding: 30 }}
    >
      <div className="flex flex-col md:flex-row justify-between md:items-center md:p-20 md:pt-20  md:mb-20 ">
        <h1 className="text-white font-bold text-3xl md:text-6xl md:pl-20 md:pb-20 ">
          Projects
        </h1>
      ...
      <div className="md:flex md:justify-between">
        <div className="md:pl-20 justify-center text-center">
          <h1 className="text-white md:text-4xl text-2xl p-40 mt-20 font-bold">
            Got Any Questions?
          </h1>

          <button className="hidden border border-white text-white md:flex p-3 rounded-md mt-40">
            ASK A QUESTION <FaArrowRightLong className=" pl-5" />
          </button>
        </div>

        <div className="md:pr-20 md:w-1/2 ">
          <h1 className="flex text-white mt-20 justify-between font-bold mb-10">
            What services does Tikuntech offer? <FaPlus className="ml-10" />
          </h1>

          <Image src={ServiceLine} alt="ServiceLine" />
          <h1 className="flex text-white mt-5 justify-between font-bold mb-10">
            Which IT solution is for my business? <FaPlus className="ml-10" />
          </h1>
          <Image src={ServiceLine} alt="ServiceLine" />
          <h1 className="flex text-white mt-5 justify-between font-bold ">
            How much do the services cost? <CgMathMinus className="ml-10" />
          </h1>
          <p className="text-white mt-5 text-sm mb-10">
