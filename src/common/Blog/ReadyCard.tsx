...
const ReadyCard: React.FC = () => {
  return (
    ...
    <div className="bg-[#11112B] p-8 md:p-12 flex flex-col  items-center justify-center text-center rounded-2xl ">
      <div className=" ">
        <h2 className="font-bold text-white text-2xl md:text-6xl lg:text-6xl md:w-1/2">
          <span>Ready to take your </span>
          <span className='font-thin' style={{fontStyle:'italic'}}> Business' IT </span>
